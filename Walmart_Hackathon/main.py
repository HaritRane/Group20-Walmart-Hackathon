...
st.set_page_config(
 ...
 # Add a custom class for the background image
page_by_img = """
<style>{
background-image: url("https://media.istockphoto.com/id/1253294358/photo/phishing-attack.jpg?s=612x612&w=0&k=20&c=CrNykt8Y6mFV4OyMVM4buB3LkZh66LP2D2zI_L60HDw=")
}
</style>
"""
...
name = st.text_input('Enter website link:')
import numpy as np
# url="https://facelook.shop.co/login.php
# "
#can provide any URL. this URL was taken from PhishTank
obj = FeatureExtraction(name)
x = np.array(obj.getFeaturesList()).reshape(1,30)
y_pred =gbc.predict(x)[0]
if y_pred==1:
  st.write("We guess it is a safe website ✅")
else:
  st.write("Caution! Suspicious website detected ⚠️")
...
#     obj2 = FeatureExtraction(url)
#     x = np.array(obj2.getFeaturesList()).reshape(1, 30)
#     y_pred = gbc.predict(x)[0]
#     if y_pred == 1:
...
#
#     # Call the classification function (replace with your actual model call)
#
#     # Return the classification result as a JSON response
#     return jsonify({'isPhishing': result})
# app.run()